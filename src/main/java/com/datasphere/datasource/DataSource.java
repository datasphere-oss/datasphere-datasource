...
import static com.datasphere.datasource.DataSource.SourceType.HDFS;
import static com.datasphere.datasource.DataSource.SourceType.HIVE;
import static com.datasphere.datasource.DataSource.SourceType.JDBC;
import static com.datasphere.datasource.DataSource.SourceType.REALTIME;
import static com.datasphere.datasource.DataSource.SourceType.SNAPSHOT;
...
public class DataSource extends AbstractHistoryEntity implements DSSDomain<String>, ContextEntity {
  ...
  /**
   * Data source used in engine (data source name used in actual query)
   */
  ...
  /**
   * Use the list of field names (,) delimiters that make up the partition
   */
  ...
  public boolean checkMatchedSrcTypeAndIngetsionInfo(IngestionInfo info) {
    ...
    if (info instanceof HdfsIngestionInfo && srcType == HDFS) {
      ...
      return true;
    } else if (info instanceof HdfsIngestionInfo && srcType == SNAPSHOT) {
      return true;
    }
