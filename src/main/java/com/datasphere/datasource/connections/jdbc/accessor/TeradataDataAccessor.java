...
@Extension
public class TeradataDataAccessor extends AbstractJdbcDataAccessor {

  private static final Logger LOGGER = LoggerFactory.getLogger(TeradataDataAccessor.class);
