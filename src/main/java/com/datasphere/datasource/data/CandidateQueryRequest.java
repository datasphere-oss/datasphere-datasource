...
import static com.datasphere.datasource.data.CandidateQueryRequest.SortCreteria.COUNT;
  ...
  public JsonNode makeResult(JsonNode root) throws QueryTimeExcetpion {
    ...
    if (root.get(0).has("result")) {
      ...
      if (root.get(0).has("columns")) {  // SegmentMetaQuery Case
        ...
        com.datasphere.datasource.Field field = dataSource.getMetaDataSource().getFieldByName(targetField.getName());
